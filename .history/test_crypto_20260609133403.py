"""
Unit test untuk fungsi enkripsi/dekripsi AES-GCM di crypto_utils.py.

Menggunakan pytest. Test utama memanggil encrypt_with_key() dan decrypt_with_key()
agar tidak bergantung pada streamlit.session_state.
"""
