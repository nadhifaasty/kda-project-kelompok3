...
class TestRoundtrip:
    """Memverifikasi proses enkripsi -> dekripsi menghasilkan plaintext awal."""

    def test_aes128_roundtrip(self):
        print("  ➡️  Enkripsi teks 'Hello AES-128-GCM' pakai kunci 128 bit, lalu")
    ...
    def test_long_text(self):
        print("  ➡️  Coba enkripsi teks sangat panjang (100.000 huruf A).")
...
class TestOutputFormat:
    """Memeriksa format output ciphertext."""

    def test_ciphertext_is_valid_base64(self):
        print("  ➡️  Hasil enkripsi harus berupa teks Base64.")
...
class TestNonDeterminism:
    """Setiap enkripsi menghasilkan output berbeda (nonce acak)."""

    def test_nonce_makes_each_run_unique(self):
        print("  ➡️  Enkripsi teks yang SAMA sebanyak 5 kali.")
...
class TestErrorHandling:
    """Fungsi dekripsi harus melempar ValueError pada input bermasalah."""
...
class TestKeyManagement:
    """Memverifikasi fungsi pembuatan kunci."""
