"""
Demo langsung enkripsi AES-GCM untuk presentasi Secure Notes.
Menunjukkan enkripsi/dekripsi, nonce random, deteksi data rusak,
salah kunci, struktur ciphertext, dan perbandingan dengan AES-CBC.
"""
